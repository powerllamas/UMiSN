...
\label{fig:dataset_and}
\caption{Zbiór uczący funkcji "AND"}
\end{figure}
...
\caption{Funkcja odpowiedzi sieci liniowej. Problem "AND".}
\end{figure}
...
\caption{Błąd średniokwadratowy dla sieci liniowej. Problem "AND".}
\end{figure}
...
\caption{Funkcja odpowiedzi sieci nieliniowej jednowarstwowej. Problem "AND".}
\end{figure}
...
\caption{Błąd średniokwadratowy dla sieci nieliniowej jednowarstwowej. Problem "AND".}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{dane/part1/zad2/error_case_nonlinear}
\label{fig:error_nonlinear_case}
\caption{Błąd dla poszczególnych przypadków dla sieci nieliniowej jednowarstwowej. Problem "AND".}
\end{figure}

Sieć nielinowa poradziła sobie z problemem znacznie lepiej - błędy klasyfikacji bliskie zeru. W przeciwieństwie do sieci liniowej widać, że proces uczenia jest zbieżny - wraz z uczeniem błąd asymptotycznie maleje.
\item \textbf{
...
\caption{Prosta separująca klasy decyzyjne dla problemu "AND".}
\end{figure}

Prosta dobrze realizuje separację klas decyzyjnych - oddziela 3 przypadki o wartości 0 od przypadku o wartości 1
...
\label{fig:dataset_xor}
\caption{Zbiór uczący funkcji "XOR"}
\end{figure}
...
\\Jak widać na rysunkach \ref{fig:response_nonlinear_xor}, \ref{fig:error_nonlinear_xor} i \ref{fig:error_case_nonlinear_xor} sieć 
...
\label{fig:response_linear_xor}
\caption{Funkcja odpowiedzi sieci liniowej dla problemu "XOR"}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{dane/part1/zad2/error_xor}
\label{fig:error_linear_xor}
\caption{Błąd średniokwadratowy sieci liniowej dla problemu "XOR".}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{dane/part1/zad2/error_case_xor}
\label{fig:error_case_nonlinear_xor}
\caption{Błąd sieci liniowej dla problemu "XOR" dla poszczególnych przypadków .}
\end{figure}
...
\label{fig:response_nonlinear_xor}
\caption{Funkcja odpowiedzi sieci nieliniowej jednowarstwowej dla problemu "XOR".}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{dane/part1/zad2/error_nonlinear_xor}
\label{fig:error_nonlinear_xor}
\caption{Błąd średniokwadratowy sieci nieliniowej jednowarstwowej dla problemu "XOR".}
\end{figure}
...
\label{fig:response_221_xor}
\caption{Funkcja odpowiedzi sieci nieliniowej 2-2-1 dla problemu "XOR".}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{dane/part1/zad2/error_221_xor}
\label{fig:error_221_xor}
\caption{Błąd średniokwadratowy sieci nieliniowej 2-2-1 dla problemu "XOR"..}
\end{figure}
...
\label{fig:prosta_separujaca_xor}
\caption{Proste separująca klasy decyzyjne dla problemu "XOR". Neurony warstwy ukrytej.}
\end{figure}
