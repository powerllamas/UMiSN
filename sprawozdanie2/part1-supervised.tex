...
\caption{Częstość klsyfikacji poprawnych, błędnych i niezaklasyfikowanych w funkcji proporcji rozmiaru zbioru weryfikującego do rozmiaru zbioru użytego podczas uczenia .\label{fig:verify}}
\end{figure}
